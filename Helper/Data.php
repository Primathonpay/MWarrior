...
namespace Primathonpay\MWarrior\Helper;

/**
 * Helper Class for all Payment Methods
 *
 * Class Data
 * @package Primathonpay\MWarrior\Helper
 */
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    /**
     * Generates WebApiException from Exception 
    ...
    public function getArrayFromGatewayResponse($response)
    {
        try {
          ...
          if (isset($arResponse['status'])) {

            $arResponse = $arResponse['status'];

            if (isset($arResponse['responseData']['cardNumber'])) {
              $arResponse['cc_number_enc'] =
                $arResponse['responseData']['cardNumber'];
            }

            if (isset($arResponse['responseData']['cardID'])) {
              $arResponse['cardID'] = $arResponse['responseData']['cardID'];
            }
            if (isset($arResponse['responseData']['responseMessage'])) {
              $arResponse['responseMessage'] = $arResponse['responseData']['responseMessage'];
            }
             if (isset($arResponse['responseData']['responseCode'])) {
              $arResponse['responseCode'] = $arResponse['responseData']['responseCode'];
            }
          }
